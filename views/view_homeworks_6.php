...
<?php
// TODO можеть быть тут вставить некую процедуру типа runPage()
// а в ней обрабатывать данные из массивов POST и GET
// и в зависимости от этих данных (значений пармертов) отрисовывать необходимую часть страницы
if (!empty($_POST))
    handle_post();
if (!empty($_GET))
    handle_get();
